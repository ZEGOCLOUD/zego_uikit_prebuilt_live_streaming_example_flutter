...
class YourGameServer {
  ...
  Future<String> getToken({required int appID, required String userID, String? serverSecret}) async {
    ...
    final response = await dio.post('$miniGameHostUrl/$apiToken', data: {'app_id': appID, 'user_id': userID});
    return response.data.toString();
  }

  Future<dynamic> getUserCurrency({required int appID, required String userID, required String gameID}) async {
    Response response;
    final dio = Dio();
